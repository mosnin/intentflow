...
| --- | --- | --- | --- |
| Desktop navigation | 64px fixed header, left lockup, compact links, two cut-corner CTAs | Same geometry and interaction model; simplified to Products, Case Studies, About, assessment, and call CTAs | Match |
