        ...
        return (
          ...
          >
            ...
            >
              {opt.label}
              {opt.value && (
                <span className="rounded-[3px] bg-[#b8500c] px-1.5 py-0.5 text-[11px] font-semibold leading-none text-white">
                  -25%
                </span>
              )}
            </span>
      ...
      <div className="mt-12 grid gap-5 lg:grid-cols-3 lg:gap-6">
        {TIERS.map((tier) => {
          ...
          return (
            <div
              key={tier.name}
              className={`p-px ${tier.highlighted ? "bg-[#b8500c]" : "bg-border"}`}
              style={clip}
            >
              <article
                ...
                <header className="flex items-start justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2.5">
                      ...
                      {tier.highlighted && (
                        <span className="rounded-[3px] bg-[#b8500c] px-2 py-0.5 text-[11px] font-semibold leading-none text-white">
                          Most popular
                        </span>
                      )}
                    </div>
                ...
                <ul className="flex-1 space-y-3">
                  {tier.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-2.5">
                      <CircleCheck
                        className="mt-0.5 h-[18px] w-[18px] shrink-0 text-[#b8500c]"
                        aria-hidden="true"
                      />
