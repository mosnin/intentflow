...
export function TypingAnimation({
  ...
  const shouldStart = (startOnView ? isInView : true) && !prefersReducedMotion;
  useEffect(() => {
  ...
  return (
    <MotionComponent
      ...
      {...props}
    >
      {prefersReducedMotion ? (wordsToAnimate[0] ?? "") : displayedText}
      {shouldShowCursor && !prefersReducedMotion && (
        <span
          className={cn(
            "inline-block",
